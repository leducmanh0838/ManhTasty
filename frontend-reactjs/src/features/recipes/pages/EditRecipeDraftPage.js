                    ...
                    <header className="d-flex align-items-center justify-content-between p-3 shadow bg-white sticky-top mt-2 mx-2 rounded">
                        <div className="d-flex justify-content-between align-items-center w-100">
                            ...
                            <div className="d-flex">
                                <ConfirmDeleteDialogButton handleDelete={handleDeleteRecipeDraft} message={"Bạn có chắc chắn muốn xóa bản nháp này không? Hành động này không thể hoàn tác."} >
...
export default EditRecipeDraftPage;